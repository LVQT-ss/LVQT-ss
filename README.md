...
### 🎮 [KEYHAY - Gaming E-commerce Platform](https://keyhay.com)
**Tech Stack:** Next.js 16, NestJS, PostgreSQL, Redis, Cloudflare, Docker

- ⚡ Architected a scalable OTC gaming top-up system with `<100ms` API latency using Dual-Layer Caching.
- 🛡️ Implemented dynamic Auto-Ban rate-limiting against DDoS/Spam via Redis and Cloudflare WAF.
- 🔄 Built real-time transaction event-driven architecture using Socket.IO & BullMQ.
- 🚀 Orchestrated fully automated CI/CD deployment pipelines using GitHub Actions & Docker.

### 🛒 [E-Commerce Computer Platform](https://github.com/LVQT-ss/SHOPC.git)
**Tech Stack:** React.js, Express.js, React Native, PostgreSQL

- 🌐 Developed cross-platform e-commerce system (Web + Android)
- 🔧 Created interactive PC builder tool with hardware compatibility checking
- 💳 Integrated VietQR & Casso webhook payment for real-time notifications
- 📊 Built comprehensive admin dashboard with data analytics

### 📱 [POS Mobile Application](https://github.com/LVQT-ss/RN-assigment.git)
**Tech Stack:** React Native, Express.js, Google Maps API

- 📍 Integrated Google Maps for live employee location tracking
- 📲 Built offline-first architecture with data persistence
- 🧾 Implemented invoice generation with automated PDF export
...
- 🎓 **Software Engineering Graduate** at FPT University
- 💼 **Full-Stack Developer** currently working at Galasoft
- 💻 **DevOps & Cloud Practitioner** with hands-on enterprise-level experience
- 🚀 **Built KEYHAY** - A production-level system handling real-time transactions
